...
public class Livraison {
    ...
    private String id_commande_id;
    private Livreur Livreur;

    public Livraison() {
    }

    public Livraison(String nom, Date date, String add, String tel, String commande, Livreur livreur) {
    ...
    public Livraison(int id, String nom, Date date, String add, String tel, String commande, Livreur livreur) {
        this.id = id;
        this.nom_destination = nom;
        this.date_livraison = date;
        this.adresse_destination = add;
    ...
    public String getId_commande_id() {
        return id_commande_id;
    }

    public void setId_commande_id(String commande) {
        this.id_commande_id = commande;
    }
