...
User user = Session.getUser();
        ...
        controller.setParam1(user.getId());
    ...
    private void Share(ActionEvent event) throws IOException {
          FXMLLoader loader = new FXMLLoader(getClass().getResource("MailingEvent.fxml"));
       
        MailingEventController controller = new MailingEventController();
        Event E=EL.get(i);
         p=E.getIdEvent();
        controller.setParam(p);
