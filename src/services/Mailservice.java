...
public class Mailservice {
    ...
    public void sendMail(String recipient,String nom, String prenom) {
        ...
        try {
            ...
            //Html code in email :
            message.setContent(
                    "<h1 style \"color:red\" >Cher Client " + nom  +prenom+ " </h1> "
                            + "<br/> <h2>Nous vous informe que votre demande est bien confirmee nous vous contacter trés bien pour la date d'entretien </h2> </br> ",
                    "text/html");
